        ...
        <div className="space-y-6 max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                {theme.logoUrl ? (
                                    ...
                                    <div className="h-8 px-4 rounded-md flex items-center text-white font-bold text-sm" style={{ background: theme.primaryColor || 'var(--color-primary)' }}>
                                        {g.storeName || 'Anandabazar BDMart'}
                                    </div>
                                )}
                            </div>
                ...
                <SettingSection icon={LuGlobe} title="SEO & Marketing" description="Search engine and tracking settings">
                    <InputField label="Meta Title" value={seo.title || ''} onChange={(e: any) => updateSeo('title', e.target.value)} placeholder="Anandabazar BDMart - Your trusted online marketplace" helper="Recommended: 50-60 characters" />
